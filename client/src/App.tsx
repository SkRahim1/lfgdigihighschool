  ...
  return (
    <Router>
      <div className="flex flex-col min-h-screen">
        ...
        {/* Floating Maps Location Button */}
        <a 
          href="https://maps.app.goo.gl/KiJwCBDDaHFaczYW8"
          target="_blank"
          rel="noopener noreferrer"
          className="fixed bottom-6 left-6 bg-amber-500 hover:bg-amber-600 text-slate-950 p-4 rounded-full shadow-2xl hover:scale-110 active:scale-95 transition-all duration-300 z-50 flex items-center justify-center border border-amber-400"
